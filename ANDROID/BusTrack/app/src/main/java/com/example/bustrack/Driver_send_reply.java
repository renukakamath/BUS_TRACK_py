...
public class Driver_send_reply extends AppCompatActivity implements JsonResponse {
    EditText e1;
    Button b1;
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_send_reply);
...
//        jr.execute(q);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                JsonReq jr= new JsonReq();
                jr.json_response=(JsonResponse) Driver_send_reply.this;
                String q="/Driver_send_reply/?late_ids="+Driver_view_late_request.late_ids+"&complaint="+complaint;
