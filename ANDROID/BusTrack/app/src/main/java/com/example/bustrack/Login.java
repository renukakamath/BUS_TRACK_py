    ...
    public void response(JSONObject jo) {
        ...
        try {
            ...
            if (status.equalsIgnoreCase("success")) {
                ...
                {
                    final  CharSequence[] items = {"Student","Parent", "Cancel"};

                        AlertDialog.Builder builder = new AlertDialog.Builder(Login.this);

                         builder.setTitle("Choose Your Login Option!");
                        builder.setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int item) {
                                ...
                                if (items[item].equals("Student")) {
                                    ...
                                    SharedPreferences.Editor e = sh.edit();
                                    e.putString("usertype", "Student");
                                    e.commit();

                                    Toast.makeText(getApplicationContext(),"Login Successfully", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(getApplicationContext(),Studenthome.class));
                                }
                                else if (items[item].equals("Parent")) {

                                    SharedPreferences.Editor e = sh.edit();
                                    e.putString("usertype", "Parent");
                                    e.commit();
